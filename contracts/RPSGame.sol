...
contract RPSGame  {
    ...
    function reveal() public {
        ...
        address[] storage loserArray = picking[loserPick];
        for(index = 0; index < loserArray.length; index++) {
            address loserAddress = loserArray[index];
            stakeOf[loserAddress] = 0;           
        }
